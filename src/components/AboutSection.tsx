        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Помогаю бизнесам автоматизировать процессы с помощью AI‑агентов:
              от обработки заявок и анализа документов до внутренних ассистентов
              для команд. Работаю от идеи и прототипа до боевого запуска и
              сопровождения.
            </p>
