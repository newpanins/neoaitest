  ...
  return (
    <div className="min-h-screen bg-background noise-bg relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center min-h-screen">
        ...
        {/* Title */}
        <motion.h1
          className="text-3xl md:text-5xl font-bold text-center mt-8 mb-2 leading-tight"
        ...
        {/* Messages */}
        <div className="w-full max-w-2xl px-6 mt-8 flex-1 overflow-y-auto max-h-[40vh] space-y-4 scrollbar-thin">
          <AnimatePresence>
            {messages.map((msg, i) => (
              <motion.div
                key={i}
        ...
        {/* Text input */}
        <div className="w-full max-w-2xl px-6 py-6 mt-auto">
